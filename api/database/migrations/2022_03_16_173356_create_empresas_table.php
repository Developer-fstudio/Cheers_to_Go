...
class CreateEmpresasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('empresas', function (Blueprint $table) {
            ...
            $table->boolean('IsTwilioActive')->default(true)->nullable();
            ...
            $table->string('horaMsgAniversario')->default('09:00')->nullable();
            $table->string('MsgAniversario')->default('Parabens')->nullable();
            $table->timestamps();
        });
    }
